...
#### HuffmanTree
Taas käytetään samaa esim. puuta, joka on luotu kuitenkin käsin ennen testejä. Testataan merkkien ja koodien etsiminen.
...
#### IntList
Get- ja add -metodien lisäksi testataan iteraattori, listan kasvattmista sekä toinen konstruktori, joka luoma lista sisältää 
